...
import { getAuctionData, subscribeAuctionData } from "../../../../shared/ETHQuery";
                    ...
                    if (cell.column.Header === "BLOCK NUMBER") {
                      ...
                      data = (
                        <p className="text-sm font-bold text-navy-500 dark:text-white">
                          <a href={`https://sepolia.etherscan.io/address/${cell.value}`} target="_blank" rel="noopener noreferrer" >{cell.value}</a>
                        </p>
                      );
                    }
                    return (
